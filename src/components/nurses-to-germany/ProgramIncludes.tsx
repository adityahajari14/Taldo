...
export default function ProgramIncludes() {
    return (
        <div className="flex w-full flex-col items-start gap-9 px-20 py-16">
            {/* Header Section */}
            <div className="flex w-full flex-col items-start gap-2.5">
                <h1 className="w-full font-['Albert_Sans',sans-serif] text-[44px] font-medium leading-[1.29] tracking-[-0.88px] text-[#18191f]">
                    <span>Gateway to </span>
                    <span className="text-[#0829e6]">German Program</span>
                    <span> for Nurses</span>
                </h1>
                <div className="w-full font-['Albert_Sans',sans-serif] text-[20px] font-normal leading-[1.29] tracking-[-0.4px] text-black">
                    <p className="mb-0">
                        Taldo's Gateway to Germany is a structured end-to-end program designed to prepare Indian
                    </p>
                    <p>nurses for a strong start in the German healthcare system.</p>
                </div>
            </div>

            {/* Program Includes Section */}
            <div className="flex w-full flex-col items-center gap-5">
                <h2 className="w-full font-['Albert_Sans',sans-serif] text-[28px] font-medium leading-[1.15] tracking-[-0.56px] text-black">
                    ...
                    <div className="flex w-full items-stretch gap-6">
                        ...
                        <div className="flex min-h-full flex-1 flex-col items-start gap-[13px] overflow-clip rounded-2xl border border-solid border-[#a5a6f6] bg-[#fbfbff] px-[18px] py-4 backdrop-blur-[2px] backdrop-filter">
                            <div className="flex items-center gap-3">
                                ...
                                <p className="whitespace-nowrap font-['Albert_Sans',sans-serif] text-[20px] font-medium leading-[1.39] tracking-[-0.4px] text-[#0829e6]">
                                    German Language Training (A1–B2)
                                </p>
                            </div>
                            <ul className="block w-full min-w-full font-['Albert_Sans',sans-serif] text-[20px] font-normal leading-[0] tracking-[-0.4px] text-[#0b0b0b]">
                                <li className="ms-[30px] list-disc">
                                    <span className="leading-[1.39]">
