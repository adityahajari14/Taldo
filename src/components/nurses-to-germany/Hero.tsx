...
export default function NursesToGermanyHero() {
  return (
    <section className="relative w-full h-screen flex flex-col justify-end">
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto max-w-[1440px] px-20 py-20">
        {/* Header */}
        <div className="mb-6">
          <h1 className="mb-4 text-[48px] font-bold text-white">
            Nurses to Germany
          </h1>
          <p className="max-w-[1280px] text-base leading-relaxed text-white/90">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-3 gap-6">
            {benefits.map((benefit) => (
              <div
                key={benefit.title}
                className="flex flex-col gap-2 rounded-2xl bg-[rgba(255,255,255,0.1)] p-4 backdrop-blur-sm"
              >
                {/* Icon */}
                <div className="flex h-[60px] w-[60px] items-center justify-center rounded-xl border border-white/30 bg-transparent">
                  {benefit.icon}
                </div>
                {/* Content */}
